...
let face = "what you present to other people first"; /*Between the quotation marks, 
...
let red = "the color you associate with anger or stopping"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "the part of your body responsible for thinking and processing information"; //repeat the instructions for the word "brain"

let masculine = "strong, imposing, rough"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "the process of processing"; //define 'think' in VERB form,
